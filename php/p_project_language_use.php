...
function count_ck(){
						...
						<?php echo "window.opener.document.getElementById('".$_GET['p_project_language_use']."').value = val;" ?>
			...
			<div id="oneCueSearch">
				<form id="frmPopup" name="frmPopup" class="ocSelect" method="get" action="">
					<fieldset class="ocSelected">
										<legend><strong>키워드 선택</strong><span class="assist"> | 3개 이하 선택 </span></legend>
